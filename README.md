...
CS student at the University of South Carolina, class of 2028. Co-founder and lead engineer at **Bloxnetic**. XR developer at USC's Emergent Information Technology Lab.
...
`Python` `TypeScript/JavaScript` `Luau/Lua` `C++` `SQL`

`React` `Next.js` `Node.js` `FastAPI` `PostgreSQL` `Redis` `Prisma`

`Docker` `pytest` `Rojo/Lune`
